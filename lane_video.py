...
# filename = 'input/videos/road_car_view.mp4'
# filename = 'input/videos/road_video_1.mp4'
# filename = 'input/videos/road_video_2.mp4'
# filename = 'input/videos/road_video_3.mp4'
# filename = 'input/videos/road_video_4.mp4'
# filename = 'input/videos/road_video_5.mp4'
# filename = 'input/videos/road_video_6.mp4'
# filename = 'input/videos/road_video_7.mp4'
# filename = 'input/videos/road_video_8.mp4'
# filename = 'input/videos/road_video_9.mp4'
# filename = 'input/videos/road_video_10.mp4'
# filename = 'input/videos/road_video_11.mp4'
# filename = 'input/videos/road_video_12.mp4'
# filename = 'input/videos/road_video_13.mp4'
# filename = 'input/videos/road_video_14.mp4'
# filename = 'input/videos/road_video_15.mp4'
# filename = 'input/videos/road_video_16.mp4'
# filename = 'input/videos/road_video_17.mp4'
# filename = 'input/videos/road_video_18.mp4'
# filename = 'input/videos/road_video_19.mp4'
# filename = 'input/videos/road_video_20.mp4'
# filename = 'input/videos/road_video_21.mp4'
# filename = 'input/videos/road_video_22.mp4'
# filename = 'input/videos/road_video_23.mp4'
# filename = 'input/videos/road_video_24.mp4'
filename = 'input/videos/road_video_25.mp4'
...
# path = 'output/videos/'
output_filename = f'{filename}_with_lanes.mp4'
...
class Lane:
    ...
    def __init__(self, orig_frame):
        ...
        self.roi_points = np.float32([
            (int(0.456 * width), int(0.7 * height)),     # Top-left corner
            (0, height - 1),                             # Bottom-left corner
            (int(0.958 * width), height - 1),            # Bottom-right corner
            (int(0.6183 * width), int(0.7 * height))     # Top-right corner
        ])
    ...
    def get_line_markings(self, frame=None):
        ...
        # cv2.imshow('ff', sxbinary)

        # 1s will be in the cells with the highest Sobel derivative values
        # (i.e. strongest lane line edges)
        sxbinary = edge.mag_thresh(sxbinary, sobel_kernel=5, thresh=(110, 255))
        # cv2.imshow('ff', sxbinary)
        ...
        # _, s_binary = edge.threshold(frame[:, :, 2], thresh=(120, 255))
        # cv2.imshow('ff', s_binary)
        ...
        # cv2.imshow('ff', r_thresh)

        # Lane lines should be pure in color and have high red channel values 
        # Bitwise AND operation to reduce noise and black-out any pixels that
        # don't appear to be nice, pure, solid colors (like white or yellow lane 
        # lines.)       
        rs_binary = cv2.bitwise_and(r_thresh, s_binary)
        # cv2.imshow('ff', rs_binary)

        _, s_binary_2 = edge.threshold(hls[:, :, 2], (180, 255))
        # cv2.imshow('ff', s_binary_2)

        rs_binary = cv2.bitwise_or(rs_binary, s_binary_2)
        # cv2.imshow('ff', rs_binary)
        ...
        cv2.imshow('ff', self.lane_line_markings)
...
def main():
    ...
    result = cv2.VideoWriter(output_filename, fourcc, output_fps, (640, 360))
    ...
    while cap.isOpened():
        ...
        if success:
            ...
            # cv2.imshow("Frame edges", lane_line_markings)

            # hls = cv2.cvtColor(frame, cv2.COLOR_BGR2HLS)
            # _, sxbinary = edge.threshold(hls[:, :, 1], thresh=(80, 255))
            # sxbinary = edge.blur_gaussian(sxbinary, ksize=7)
            # sxbinary = edge.mag_thresh(sxbinary, sobel_kernel=7, thresh=(100, 255))

            # _, s_binary = edge.threshold(hls[:, :, 2], (100, 255))
            # # cv2.imshow("Frame s_binary", s_binary)
            # _, r_thresh = edge.threshold(frame[:, :, 2], thresh=(180, 255))
            # # cv2.imshow("Frame r_thresh", r_thresh)
            # rs_binary = cv2.bitwise_and(s_binary, r_thresh)
            # # cv2.imshow("Frame edges", rs_binary)
